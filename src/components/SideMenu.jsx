...
export default function SideMenu() {
  ...
  return (
    <div className="side-menu">
      ...
      <nav>
        <Link href="/" className={`nav-links ${activeLink === 1 ? "active": ""}`}>
        ...
        <Link href="/Assignments" className={`nav-links ${activeLink === 2 ? "active": ""}`}>
          <svg className="side-menu-icon">
            <path
        ...
        <Link href="/Examinations" className={`nav-links ${activeLink === 3 ? "active": ""}`}>
          <svg className="side-menu-icon">
            <path
        ...
        <Link href="/Progress" className={`nav-links ${activeLink === 4 ? "active": ""}`}>
          <svg className="side-menu-icon">
            <path
        ...
        <Link href="/Chat" className={`nav-links ${activeLink === 5 ? "active": ""}`}>
          <svg className="side-menu-icon">
            <path
        ...
        <Link href="/Settings" className={`nav-links ${activeLink === 6 ? "active": ""}`}>
          <svg className="side-menu-icon">
        ...
        <Link href="/FAQs" className={`nav-links ${activeLink === 7 ? "active": ""}`}>
          <svg className="side-menu-icon">
            <path
        ...
        <Link href="/Profile" className={`nav-links ${activeLink === 8 ? "active": ""}`}>
          <svg className="side-menu-icon">
            <path
