import Gamification2Image from "../../Images/landingpage/Gamification2.png"
        ...
        <div className="app-feature app-feature-gamification">
            ...
            <div className="left">
                ...
                <div className="gamification-signup">
                    ...
                    <div className="button1 button"><Link to="/Dashboard" className="get-started">Sign up</Link></div>
            ...
            <div className="right">
                <div className="gamification-image">
                    <img src={Gamification2Image} alt="gamificationPhoto" />
                </div>
            </div>
        </div>
    )
